...
$("#r").html(carp(res,prompt("Set Password")||""));

$("#r").val($("#r").text()).select();document.execCommand("copy");

}
function dnc(res){

$("#s").html(darp(res,prompt("Enter Password","SOLOLEARN")||""));

$("#s").val($("#s").text()).select();document.execCommand("copy");

}
alert("Decrypt Given encrypted text using password 'sololearn' ")
var c=[",,,,,",
",...",
",.,.",
",..",
